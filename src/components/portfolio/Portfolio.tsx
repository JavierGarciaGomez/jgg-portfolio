          ...
          {projects.map((project) => (
            ...
            >
              ...
              >
                ...
                <Typography
                  component={"h3"}
                  sx={{ position: "absolute", color: "white", fontSize: "20px", textAlign: "center" }}
                >
                  {project.name}
                </Typography>
              </Box>
              <Box sx={{ display: "flex", justifyContent: "center", width: "100%", gap: "1rem" }}>
                <Box component={"a"} href={project.link}>
                  <Button variant="contained" color="primary">
                    {t("common.view")}
                  </Button>
                </Box>
                <Box component={"a"} href={project.github}>
                  <Button variant="contained" color="primary">
                    Github
                  </Button>
                </Box>
